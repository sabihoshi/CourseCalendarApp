...
namespace UVACanvasAccess.ApiParts
{
    public partial class Api
    {
        ...
        {
            Default = 0,
            [ApiRepresentation("all_dates")] AllDates = 1 << 0,
            [ApiRepresentation("sections")] Sections = 1 << 1,

            [ApiRepresentation("sections_user_count")]
            SectionsUserCount = 1 << 2,
            [ApiRepresentation("overrides")] Overrides = 1 << 3
        }
        ...
        {
            [ApiRepresentation("locked")] Locked = 1 << 0,
            [ApiRepresentation("unlocked")] Unlocked = 1 << 1,
            [ApiRepresentation("pinned")] Pinned = 1 << 2,
            [ApiRepresentation("unpinned")] Unpinned = 1 << 3
        }
        ...
        public CreateDiscussionTopicBuilder CreateCourseDiscussionTopic(ulong courseId)
            => new CreateDiscussionTopicBuilder(this, "courses", courseId);
        ...
        {
            var url = $"{type}/{baseId}/discussion_topics/{topicId}" +
                BuildQueryString(inclusions.GetTuples().ToArray());
