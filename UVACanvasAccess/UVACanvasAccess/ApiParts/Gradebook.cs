...
namespace UVACanvasAccess.ApiParts
{
    public partial class Api
    {
        ...
        [PaginatedResponse]
        private Task<HttpResponseMessage> RawGetDailySubmissionHistories(string courseId, DateTime date,
            string graderId, string assignmentId)
        {
            var url
                = $"courses/{courseId}/gradebook_history/{date.ToIso8601Date()}/graders/{graderId}/assignments/{assignmentId}/submissions";
            return _client.GetAsync(url);
        }
