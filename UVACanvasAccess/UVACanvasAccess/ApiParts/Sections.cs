...
namespace UVACanvasAccess.ApiParts
{
    public partial class Api
    {
        ...
        {
            [ApiRepresentation("students")] Students = 1 << 0,
            [ApiRepresentation("avatar_url")] AvatarUrl = 1 << 1,
            [ApiRepresentation("enrollments")] Enrollments = 1 << 2,
            [ApiRepresentation("total_students")] TotalStudents = 1 << 3,
            [ApiRepresentation("passback_status")] PassbackStatus = 1 << 4,
