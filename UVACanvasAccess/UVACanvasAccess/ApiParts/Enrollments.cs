...
namespace UVACanvasAccess.ApiParts
{
    public partial class Api
    {
        ...
        {
            [ApiRepresentation("avatar_url")] AvatarUrl = 1 << 0,
            [ApiRepresentation("group_ids")] GroupIds = 1 << 1,
            [ApiRepresentation("locked")] Locked = 1 << 2,
            [ApiRepresentation("observed_users")] ObservedUsers = 1 << 3,
            [ApiRepresentation("can_be_removed")] CanBeRemoved = 1 << 4,
            [ApiRepresentation("uuid")] Uuid = 1 << 5
        }
        ...
        public enum CourseEnrollmentType
        {
            ...
            TeacherEnrollment,
            [ApiRepresentation("TaEnrollment")] TaEnrollment,
            ...
            CourseEnrollmentIncludes? includes = null)
        {
            ...
            var response
                = await _client.GetAsync($"courses/{courseId}/enrollments" +
            ...
            CourseEnrollmentIncludes? includes = null)
        {
            ...
            var response
                = await _client.GetAsync($"users/{userId}/enrollments" + BuildDuplicateKeyQueryString(args.ToArray()));
        ...
        public Task<Enrollment> ConcludeEnrollment(ulong courseId, ulong enrollmentId)
            => RawDeleteEnrollment(courseId, enrollmentId, "conclude");
        ...
        public Task<Enrollment> DeactivateEnrollment(ulong courseId, ulong enrollmentId)
            => RawDeleteEnrollment(courseId, enrollmentId, "deactivate");
        ...
        public Task<Enrollment> DeleteEnrollment(ulong courseId, ulong enrollmentId)
            => RawDeleteEnrollment(courseId, enrollmentId, "delete");
