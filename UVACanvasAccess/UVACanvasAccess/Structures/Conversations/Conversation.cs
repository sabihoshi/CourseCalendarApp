...
namespace UVACanvasAccess.Structures.Conversations
{
    ...
    public class Conversation : IPrettyPrint
    {
        ...
        internal Conversation(Api api, ConversationModel model)
        {
            ...
            ReadState = model.WorkflowState
                .ConvertIfNotNullValue(wf => wf.ToApiRepresentedEnum<ConversationReadState>().Value).Value;
        ...
        [CanBeNull] public Dictionary<string, Dictionary<string, IEnumerable<string>>> AudienceContexts { get; set; }

        [NotNull] public IEnumerable<ConversationParticipant> Participants { get; set; }

        [NotNull] public IEnumerable<string> Properties { get; set; }

        [NotNull] public IEnumerable<ulong> Audience { get; set; }
        ...
        public string ToPrettyString() => "Conversation {" +
            ($"\n{nameof(Id)}: {Id}," +
        ...
        public Task<Conversation> AddMessage(string body,
            ...
            => Api.AddMessageToConversation(Id, body, specificRecipients, includedMessages, attachmentIds,
                mediaCommentId, mediaCommentType, addJournalEntry);
        ...
        public virtual Task<DetailedConversation> AsDetailedConversation() => Api.GetConversation(Id);
    }

    [PublicAPI]
    public enum ConversationReadState : byte
    {
        [ApiRepresentation("read")] Read,
        [ApiRepresentation("unread")] Unread,
        [ApiRepresentation("archived")] Archived
    }
}