...
namespace UVACanvasAccess.Structures.Pages
{
    ...
    public class PageRevision : IPrettyPrint
    {
        ...
        public string Body
        {
            get
            {
                if (_body == null) UpdateAbsentFields();
        ...
        public string Title
        {
            get
            {
                if (_title == null) UpdateAbsentFields();
        ...
        [CanBeNull] public UserDisplay EditedBy { get; }

        public string ToPrettyString() => "PageRevision {" +
        ...
        private void UpdateAbsentFields()
        {
            ...
            Debug.Print(
                $"DEBUG: The absent fields of revision {RevisionId} of {Url} #{GetHashCode()} need to be fetched.");
