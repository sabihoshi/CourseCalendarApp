    ...
    public class Assignment : IPrettyPrint
    {
        ...
        internal Assignment(Api api, AssignmentModel model)
        {
            ...
            ExternalToolTagAttributes
                = model.ExternalToolTagAttributes.ConvertIfNotNull(m => new ExternalToolTagAttributes(api, m));
            ...
            NeedsGradingCountBySection
                = model.NeedsGradingCountBySection.SelectNotNull(m => new NeedsGradingCount(api, m));
            ...
            DiscussionTopic = model.DiscussionTopic.ConvertIfNotNull(m
                => new DiscussionTopic(api, m, DiscussionTopic.DiscussionHome.Course, model.CourseId));
        ...
        [CanBeNull] public IEnumerable<string> FrozenAttributes { get; }
        ...
        [CanBeNull] public object IntegrationData { get; }
        ...
        public string ToPrettyString() => "Assignment {" +
            ($"\n{nameof(Id)}: {Id}," +
                $"\n{nameof(Name)}: {Name}," +
