...
namespace UVACanvasAccess.Structures.Roles
{
    ...
    {
        [ApiRepresentation("become_user")] BecomeUser = 1 << 0,
        [ApiRepresentation("import_sis")] ImportSis = 1 << 1,
        ...
        [ApiRepresentation("manage_alerts")] ManageAlerts = 1 << 4,
        [ApiRepresentation("manage_catalog")] ManageCatalog = 1 << 5,
        [ApiRepresentation("manage_courses")] ManageCourses = 1 << 6,
        ...
        [ApiRepresentation("manage_jobs")] ManageJobs = 1 << 10,
        ...
        [ApiRepresentation("manage_sis")] ManageSis = 1 << 14,
        ...
        ReadCourseList = 1 << 19,
        [ApiRepresentation("read_messages")] ReadMessages = 1 << 20,
        [ApiRepresentation("reset_any_mfa")] ResetAnyMfa = 1 << 21,
        [ApiRepresentation("site_admin")] SiteAdmin = 1 << 22,
        ...
        [ApiRepresentation("view_jobs")] ViewJobs = 1 << 25,
        ...
        [ApiRepresentation("view_statistics")] ViewStatistics = 1 << 28,
    ...
    public enum GeneralRolePermissions : ulong
    {
        ...
        [ApiRepresentation("create_forum")] CreateForum = 1 << 3,

        [ApiRepresentation("create_observer_pairing_code")]
        GenerateObserverPairingCode = 1 << 4,
        [ApiRepresentation("import_outcomes")] ImportOutcomes = 1 << 5,
        [ApiRepresentation("lti_add_edit")] LtiAddEdit = 1 << 6,
        ...
        [ApiRepresentation("manage_calendar")] ManageCalendar = 1 << 9,
        [ApiRepresentation("manage_content")] ManageContent = 1 << 10,
        [ApiRepresentation("manage_files")] ManageFiles = 1 << 11,
        [ApiRepresentation("manage_grades")] ManageGrades = 1 << 12,
        [ApiRepresentation("manage_groups")] ManageGroups = 1 << 13,

        [ApiRepresentation("manage_interaction_alerts")]
        ManageInteractionAlerts = 1 << 14,
        [ApiRepresentation("manage_outcomes")] ManageOutcomes = 1 << 15,
        [ApiRepresentation("manage_sections")] ManageSections = 1 << 16,
        [ApiRepresentation("manage_students")] ManageStudents = 1 << 17,

        [ApiRepresentation("manage_user_notes")]
        ManageUserNotes = 1 << 18,
        [ApiRepresentation("manage_rubrics")] ManageRubrics = 1 << 19,
        [ApiRepresentation("manage_wiki")] ManageWiki = 1 << 20,
        [ApiRepresentation("moderate_forum")] ModerateForum = 1 << 21,
        [ApiRepresentation("post_to_forum")] PostToForum = 1 << 22,
        ...
        [ApiRepresentation("read_forum")] ReadForum = 1 << 25,

        [ApiRepresentation("read_question_banks")]
        ReadQuestionBanks = 1 << 26,
        [ApiRepresentation("read_reports")] ReadReports = 1 << 27,
        [ApiRepresentation("read_roster")] ReadRoster = 1 << 28,
        [ApiRepresentation("read_sis")] ReadSis = 1 << 29,

        [ApiRepresentation("select_final_grade")]
        SelectFinalGrade = 1 << 30,
        [ApiRepresentation("send_messages")] SendMessages = 1L << 31,

        [ApiRepresentation("send_messages_all")]
        SendMessagesAll = 1L << 32,
        [ApiRepresentation("view_all_grades")] ViewAllGrades = 1L << 33,
    ...
    public readonly struct RolePermissionsSet
    {
        ...
        {
            var allowed = GeneralAllowed.GetFlags()
                .Select(f => f.GetApiRepresentation())
                ...
                .Interleave();
            var denied = GeneralDenied.GetFlags()
                .Select(f => f.GetApiRepresentation())
            ...
            var locked = GeneralLocked.GetFlags()
                .Select(f => f.GetApiRepresentation())
