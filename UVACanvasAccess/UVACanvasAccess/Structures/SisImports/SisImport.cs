...
namespace UVACanvasAccess.Structures.SisImports
{
    ...
    public class SisImport : IPrettyPrint
    {
        ...
        [CanBeNull] public IEnumerable<IEnumerable<string>> ProcessingErrors { get; }

        [CanBeNull] public IEnumerable<IEnumerable<string>> ProcessingWarnings { get; }
        ...
        public string ToPrettyString() => "SisImport {" +
            ($"\n{nameof(Id)}: {Id}," +
