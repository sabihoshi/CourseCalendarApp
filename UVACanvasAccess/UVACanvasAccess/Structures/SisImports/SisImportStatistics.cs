...
namespace UVACanvasAccess.Structures.SisImports
{
    ...
    public class SisImportStatistics
    {
        ...
        [CanBeNull] public SisImportStatistic AbstractCourse { get; }

        [CanBeNull] public SisImportStatistic Account { get; }

        [CanBeNull] public SisImportStatistic AccountUser { get; }

        [CanBeNull] public SisImportStatistic CommunicationChannel { get; }

        [CanBeNull] public SisImportStatistic Course { get; }

        [CanBeNull] public SisImportStatistic CourseSection { get; }

        [CanBeNull] public SisImportStatistic Enrollment { get; }

        [CanBeNull] public SisImportStatistic EnrollmentTerm { get; }

        [CanBeNull] public SisImportStatistic Group { get; }

        [CanBeNull] public SisImportStatistic GroupCategory { get; }

        [CanBeNull] public SisImportStatistic GroupMembership { get; }

        [CanBeNull] public SisImportStatistic Pseudonym { get; }

        [CanBeNull] public SisImportStatistic UserObserver { get; }
