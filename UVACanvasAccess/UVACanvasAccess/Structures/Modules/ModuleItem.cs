...
namespace UVACanvasAccess.Structures.Modules
{
    ...
    {
        [ApiRepresentation("File")] File,
        [ApiRepresentation("Page")] Page,
        [ApiRepresentation("Discussion")] Discussion,
        [ApiRepresentation("Assignment")] Assignment,
        [ApiRepresentation("Quiz")] Quiz,
        [ApiRepresentation("SubHeader")] Subheader,
        [ApiRepresentation("ExternalUrl")] ExternalUrl,
        [ApiRepresentation("ExternalTool")] ExternalTool
    }

    [PublicAPI]
    public enum ModuleAssetType : byte
    {
        [ApiRepresentation("ModuleItem")] ModuleItem,
        [ApiRepresentation("File")] File,
        [ApiRepresentation("Page")] Page,
        [ApiRepresentation("Discussion")] Discussion,
        [ApiRepresentation("Assignment")] Assignment,
    ...
    public class ModuleItem : IPrettyPrint
    {
        ...
        internal ModuleItem(Api api, ModuleItemModel model)
        {
            ...
            CompletionRequirement
                = model.CompletionRequirement.ConvertIfNotNull(m => new CompletionRequirement(api, m));
        ...
        [OptIn] [CanBeNull] public CompletionRequirement CompletionRequirement { get; set; }

        public ModuleItemType Type { get; set; }

        [CanBeNull] public string ExternalUrl { get; set; }

        public string HtmlUrl { get; set; }

        [CanBeNull] public string PageUrl { get; set; }
        ...
        public string ToPrettyString() => "ModuleItem {" +
            ($"\n{nameof(Id)}: {Id}," +
