...
namespace UVACanvasAccess.Structures.Modules
{
    ...
    {
        [ApiRepresentation("locked")] Locked,
        [ApiRepresentation("unlocked")] Unlocked,
        [ApiRepresentation("started")] Started,
        [ApiRepresentation("completed")] Completed
    }
    ...
    public class Module : IPrettyPrint
    {
        ...
        [OptIn] public DateTime? CompletedAt { get; }
        ...
        [CanBeNull] public IEnumerable<ulong> PrerequisiteModuleIds { get; }

        [CanBeNull] public ModuleState? State { get; }
        ...
        public string ToPrettyString() => "Module {" +
            ($"\n{nameof(Id)}: {Id}," +
