...
namespace UVACanvasAccess.Model.Enrollments
{
    internal class EnrollmentModel
    {
        ...
        [JsonProperty("grades")] public GradeModel Grades { get; set; }
        ...
        [JsonProperty("associated_user_id")] public ulong? AssociatedUserId { get; set; }

        [JsonProperty("course_section_id")] public ulong? CourseSectionId { get; set; }
        ...
        [JsonProperty("total_activity_time")] public ulong? TotalActivityTime { get; set; }

        [JsonProperty("user")] public UserDisplayModel User { get; set; }
    }
}