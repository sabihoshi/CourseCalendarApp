...
namespace UVACanvasAccess.Model.Analytics
{
    internal class CourseAssignmentSummaryModel
    {
        ...
        [JsonProperty("first_quartile")] public decimal? FirstQuartile { get; set; }

        [JsonProperty("max_score")] public decimal? MaxScore { get; set; }

        [JsonProperty("median")] public decimal? Median { get; set; }

        [JsonProperty("min_score")] public decimal? MinScore { get; set; }

        [JsonProperty("third_quartile")] public decimal? ThirdQuartile { get; set; }
