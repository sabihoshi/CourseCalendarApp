...
namespace UVACanvasAccess.Model.Analytics
{
    ...
    internal class UserAssignmentDataModel
    {
        ...
        [JsonProperty("module_ids")] public IEnumerable<ulong> ModuleIds { get; set; }

        [JsonProperty("title")] public string Title { get; set; }

        [JsonProperty("first_quartile")] public uint? FirstQuartile { get; set; }

        [JsonProperty("max_score")] public uint? MaxScore { get; set; }

        [JsonProperty("median")] public uint? Median { get; set; }

        [JsonProperty("min_score")] public uint? MinScore { get; set; }

        [JsonProperty("points_possible")] public uint? PointsPossible { get; set; }

        [JsonProperty("third_quartile")] public uint? ThirdQuartile { get; set; }

        [JsonProperty("assignment_id")] public ulong AssignmentId { get; set; }

        [JsonProperty("submission")] public UserAssignmentSubmissionDataModel? Submission { get; set; }
    }
}