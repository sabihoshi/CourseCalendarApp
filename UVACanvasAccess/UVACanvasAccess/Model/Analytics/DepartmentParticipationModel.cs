...
namespace UVACanvasAccess.Model.Analytics
{
    ...
    internal class DepartmentParticipationModel
    {
        ...
        [JsonProperty("by_date")] public IEnumerable<DepartmentParticipationDateEntryModel> ByDate { get; set; }
    }
    ...
    internal class DepartmentParticipationDateEntryModel
    {
        ...
        [JsonProperty("participations")] public ulong Participations { get; set; }

        [JsonProperty("views")] public ulong Views { get; set; }
    }
