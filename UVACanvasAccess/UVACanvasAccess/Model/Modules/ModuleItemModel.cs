...
namespace UVACanvasAccess.Model.Modules
{
    internal class ModuleItemModel
    {
        ...
        [CanBeNull] [JsonProperty("page_url")] public string PageUrl { get; set; }
        ...
        [JsonProperty("indent")] public uint? Indent { get; set; }

        [JsonProperty("module_id")] public ulong ModuleId { get; set; }

        [JsonProperty("content_id")] public ulong? ContentId { get; set; }
    }
}