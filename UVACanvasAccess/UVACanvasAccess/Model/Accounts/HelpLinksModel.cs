...
namespace UVACanvasAccess.Model.Accounts
{
    ...
    {
        [JsonProperty("custom_help_links")] public IEnumerable<HelpLinkModel> CustomHelpLinks { get; set; }

        [JsonProperty("default_help_links")] public IEnumerable<HelpLinkModel> DefaultHelpLinks { get; set; }
