...
namespace UVACanvasAccess.Model.Quizzes
{
    internal class QuizPermissionsModel
    {
        ...
        [JsonProperty("read_statistics")] public bool ReadStatistics { get; set; }

        [JsonProperty("review_grades")] public bool ReviewGrades { get; set; }

        [JsonProperty("submit")] public bool Submit { get; set; }
