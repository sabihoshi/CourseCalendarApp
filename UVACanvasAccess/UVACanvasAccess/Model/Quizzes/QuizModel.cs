...
namespace UVACanvasAccess.Model.Quizzes
{
    internal class QuizModel
    {
        ...
        [JsonProperty("cant_go_back")] public bool? CantGoBack { get; set; }
        ...
        [JsonProperty("one_time_results")] public bool? OneTimeResults { get; set; }

        [JsonProperty("published")] public bool? Published { get; set; }

        [JsonProperty("show_correct_answers")] public bool? ShowCorrectAnswers { get; set; }

        [JsonProperty("show_correct_answers_last_attempt")]
        public bool? ShowCorrectAnswersLastAttempt { get; set; }

        [JsonProperty("shuffle_answers")] public bool? ShuffleAnswers { get; set; }
        ...
        [JsonProperty("time_limit")] public decimal? TimeLimit { get; set; }

        [JsonProperty("question_types")] public IEnumerable<string> QuestionTypes { get; set; }
        ...
        [JsonProperty("permissions")] public QuizPermissionsModel Permissions { get; set; }
        ...
        [JsonProperty("mobile_url")] public string MobileUrl { get; set; }

        [JsonProperty("preview_url")] public string PreviewUrl { get; set; }

        [JsonProperty("quiz_extensions_url")] public string QuizExtensionsUrl { get; set; }

        [JsonProperty("quiz_type")] public string QuizType { get; set; }
        ...
        [JsonProperty("question_count")] public uint? QuestionCount { get; set; }

        [JsonProperty("version_number")] public uint? VersionNumber { get; set; }

        [JsonProperty("assignment_group_id")] public ulong AssignmentGroupId { get; set; }
    }
}