...
namespace UVACanvasAccess.Model.Users
{
    internal class ActivityStreamObjectModel
    {
        ...
        [JsonProperty("read_state")] public bool ReadState { get; set; }
        ...
        [JsonProperty("user_has_posted")] public bool? UserHasPosted { get; set; }
        ...
        [JsonProperty("participant_count")] public uint? ParticipantCount { get; set; }
        ...
        [JsonProperty("announcement_id")] public ulong? AnnouncementId { get; set; }
        ...
        [JsonProperty("collaboration_id")] public ulong? CollaborationId { get; set; }

        //
        // Type = Conversation

        [JsonProperty("conversation_id")] public ulong? ConversationId { get; set; }
        ...
        [JsonProperty("discussion_topic_id")] public ulong? DiscussionTopicId { get; set; }
        ...
        [JsonProperty("web_conference_id")] public ulong? WebConferenceId { get; set; }
