...
namespace UVACanvasAccess.Model.Users
{
    internal class PageViewModel
    {
        ...
        [JsonProperty("user_request")] public bool? UserRequest { get; set; }

        [JsonProperty("created_at")] public DateTime CreatedAt { get; set; }

        [JsonProperty("interaction_seconds")] public decimal? InteractionSeconds { get; set; }

        [JsonProperty("render_time")] public double? RenderTime { get; set; }

        [JsonProperty("links")] public PageViewLinksModel Links { get; set; }
        ...
        [JsonProperty("http_method")] public string HttpMethod { get; set; }

        [JsonProperty("remote_ip")] public string RemoteIp { get; set; }
