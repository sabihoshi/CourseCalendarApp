...
namespace UVACanvasAccess.Model.Authentications
{
    ...
    internal class AuthenticationEventModel
    {
        ...
        [JsonProperty("links")] public AuthenticationEventLinksModel Links { get; set; }
    ...
    {
        [JsonProperty("login")] public ulong Login { get; set; }

        [JsonProperty("account")] public ulong Account { get; set; }

        [JsonProperty("user")] public ulong User { get; set; }

        [JsonProperty("page_view")] public ulong? PageView { get; set; }
    }
}