...
namespace UVACanvasAccess.Model.Assignments
{
    internal class AssignmentModel
    {
        ...
        [CanBeNull] [JsonProperty("rubric")] public IEnumerable<RubricCriteriaModel> Rubric { get; set; }
        ...
        [JsonProperty("submission_types")] public IEnumerable<string> SubmissionTypes { get; set; }
        ...
        [JsonProperty("grader_count")] public uint GraderCount { get; set; }

        [JsonProperty("max_name_length")] public uint MaxNameLength { get; set; }

        [JsonProperty("needs_grading_count")] public uint? NeedsGradingCount { get; set; }

        [JsonProperty("peer_review_count")] public uint? PeerReviewCount { get; set; }
        ...
        [JsonProperty("position")] public ulong Position { get; set; }

        [JsonProperty("final_grader_id")] public ulong? FinalGraderId { get; set; }

        [JsonProperty("grading_standard_id")] public ulong? GradingStandardId { get; set; }

        [JsonProperty("group_category_id")] public ulong? GroupCategoryId { get; set; }

        [JsonProperty("quiz_id")] public ulong? QuizId { get; set; }
    }
}