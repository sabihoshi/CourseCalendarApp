...
namespace UVACanvasAccess.Model.Appointments
{
    internal class AppointmentGroupModel
    {
        ...
        [JsonProperty("requiring_action")] public bool? RequiringAction { get; set; }
        ...
        [JsonProperty("reserved_times")] public IEnumerable<AppointmentModel> ReservedTimes { get; set; }

        [JsonProperty("appointments")] public IEnumerable<CalendarEventModel> Appointments { get; set; }

        [JsonProperty("new_appointments")]
        [CanBeNull]
        public IEnumerable<CalendarEventModel> NewAppointments { get; set; }

        [JsonProperty("context_codes")] public IEnumerable<string> ContextCodes { get; set; }

        [JsonProperty("sub_context_codes")] public IEnumerable<string> SubContextCodes { get; set; }

        [JsonProperty("description")] public string Description { get; set; }

        [JsonProperty("html")] public string HtmlUrl { get; set; }
        ...
        [JsonProperty("appointments_count")] public uint AppointmentsCount { get; set; }
