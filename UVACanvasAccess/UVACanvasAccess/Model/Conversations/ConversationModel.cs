...
namespace UVACanvasAccess.Model.Conversations
{
    internal class ConversationModel
    {
        ...
        [JsonProperty("last_message_at")] public DateTime? LastMessageAt { get; set; }
        ...
        [CanBeNull] [JsonProperty("audience")] public IEnumerable<ulong> Audience { get; set; }

        [JsonProperty("avatar_url")] public string AvatarUrl { get; set; }

        [JsonProperty("context_name")] public string ContextName { get; set; }

        [JsonProperty("last_message")] public string LastMessage { get; set; }

        [JsonProperty("subject")] public string Subject { get; set; }

        [JsonProperty("workflow_state")] public string WorkflowState { get; set; }

        [JsonProperty("message_count")] public uint MessageCount { get; set; }
    }
}