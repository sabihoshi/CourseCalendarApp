...
namespace UVACanvasAccess.Model.Groups
{
    internal class GroupModel
    {
        ...
        [JsonProperty("followed_by_user")] public bool FollowedByUser { get; set; }
        ...
        [JsonProperty("join_level")] public string JoinLevel { get; set; }
        ...
        [JsonProperty("members_count")] public uint MembersCount { get; set; }

        [JsonProperty("storage_quota_mb")] public uint StorageQuoteMb { get; set; }
