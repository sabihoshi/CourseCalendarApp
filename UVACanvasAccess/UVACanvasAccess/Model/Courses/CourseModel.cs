...
namespace UVACanvasAccess.Model.Courses
{
    internal class CourseModel
    {
        ...
        [JsonProperty("calendar")] public CalendarLinkModel Calendar { get; set; }
        ...
        [JsonProperty("term")] [CanBeNull] public TermModel Term { get; set; }
        ...
        [JsonProperty("enrollment_term_id")] public ulong EnrollmentTermId { get; set; }

        [JsonProperty("root_account_id")] public ulong RootAccountId { get; set; }

        [JsonProperty("storage_quota_mb")] public ulong StorageQuotaMb { get; set; }
        ...
        [JsonProperty("total_students")] public ulong? TotalStudents { get; set; }
    }
}