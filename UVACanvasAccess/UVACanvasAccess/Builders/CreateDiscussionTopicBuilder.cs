...
namespace UVACanvasAccess.Builders
{
    ...
    public class CreateDiscussionTopicBuilder
    {
        ...
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public CreateDiscussionTopicBuilder WithAttachment() => throw new NotImplementedException("not yet supported");
        ...
        ///         and 'threaded' for fully threaded discussions.
        ///     </c>
        /// </summary>
        ...
        public Task<DiscussionTopic> Post() => _api.PostNewDiscussionTopic(this);
    }
}