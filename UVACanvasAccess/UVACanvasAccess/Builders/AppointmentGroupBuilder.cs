...
namespace UVACanvasAccess.Builders
{
    ...
    public class AppointmentGroupBuilder
    {
        ...
        /// </summary>
        /// <returns>This builder.</returns>
        public AppointmentGroupBuilder Published() => Put("publish", "1");

        /// <summary>
        ///     The description of this group.
        /// </summary>
        /// <returns>This builder.</returns>
        public AppointmentGroupBuilder WithDescription(string description) => Put("description", description);

        /// <summary>
        ///     The address of the location of this group.
        /// </summary>
        /// <returns>This builder.</returns>
        public AppointmentGroupBuilder WithLocationAddress(string address) => Put("location_address", address);

        /// <summary>
        ///     The name of the location of this group.
        /// </summary>
        /// <returns>This builder.</returns>
        public AppointmentGroupBuilder WithLocationName(string location) => Put("location_name", location);
        ...
        public AppointmentGroupBuilder WithMaxAppointments(uint appointments)
            => Put("max_appointments_per_participant", appointments.ToString());
        ...
        public AppointmentGroupBuilder WithMaxParticipants(uint participants)
            => Put("participants_per_appointment", participants.ToString());
        ...
        public AppointmentGroupBuilder WithMinAppointments(uint appointments)
            => Put("min_appointments_per_participant", appointments.ToString());
        ...
        public AppointmentGroupBuilder WithProtectedVisibility(bool @protected = true)
            => Put("participant_visibility", @protected ? "protected" : "private");
        ...
        {
            if (!_isEditing) return _api.PostCreateAppointmentGroup(this);
